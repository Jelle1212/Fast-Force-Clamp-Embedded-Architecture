...
proc create_ipi_design { offsetfile design_name } {
	...
	# Create instance: pid_parameters_0, and set properties
	set pid_parameters_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:pid_parameters:1.0 pid_parameters_0 ]
	...
	# Connect all clock & reset of pid_parameters_0 slave interfaces..
	connect_bd_intf_net [get_bd_intf_pins axi_peri_interconnect/M00_AXI] [get_bd_intf_pins pid_parameters_0/P]
	connect_bd_net [get_bd_pins pid_parameters_0/p_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins pid_parameters_0/p_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]
	connect_bd_intf_net [get_bd_intf_pins axi_peri_interconnect/M01_AXI] [get_bd_intf_pins pid_parameters_0/I]
	connect_bd_net [get_bd_pins pid_parameters_0/i_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins pid_parameters_0/i_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]
	connect_bd_intf_net [get_bd_intf_pins axi_peri_interconnect/M02_AXI] [get_bd_intf_pins pid_parameters_0/D]
	connect_bd_net [get_bd_pins pid_parameters_0/d_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins pid_parameters_0/d_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]
	connect_bd_intf_net [get_bd_intf_pins axi_peri_interconnect/M03_AXI] [get_bd_intf_pins pid_parameters_0/N]
	connect_bd_net [get_bd_pins pid_parameters_0/n_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins pid_parameters_0/n_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]
	connect_bd_intf_net [get_bd_intf_pins axi_peri_interconnect/M04_AXI] [get_bd_intf_pins pid_parameters_0/S]
	connect_bd_net [get_bd_pins pid_parameters_0/s_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins pid_parameters_0/s_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]


	# Auto assign address
	assign_bd_address

	# Copy all address to pid_parameters_v1_0_include.tcl file
	set bd_path [get_property DIRECTORY [current_project]]/[current_project].srcs/[current_fileset]/bd
	upvar 1 $offsetfile offset_file
	set offset_file "${bd_path}/pid_parameters_v1_0_include.tcl"
	set fp [open $offset_file "w"]
	puts $fp "# Configuration address parameters"

	set offset [get_property OFFSET [get_bd_addr_segs /jtag_axi_0/Data/SEG_pid_parameters_0_D_* ]]
	puts $fp "set d_addr ${offset}"

	set offset [get_property OFFSET [get_bd_addr_segs /jtag_axi_0/Data/SEG_pid_parameters_0_I_* ]]
	puts $fp "set i_addr ${offset}"

	set offset [get_property OFFSET [get_bd_addr_segs /jtag_axi_0/Data/SEG_pid_parameters_0_N_* ]]
	puts $fp "set n_addr ${offset}"

	set offset [get_property OFFSET [get_bd_addr_segs /jtag_axi_0/Data/SEG_pid_parameters_0_P_* ]]
	puts $fp "set p_addr ${offset}"

	set offset [get_property OFFSET [get_bd_addr_segs /jtag_axi_0/Data/SEG_pid_parameters_0_S_* ]]
	puts $fp "set s_addr ${offset}"

	close $fp
}

# Set IP Repository and Update IP Catalogue 
set ip_path [file dirname [file normalize [get_property XML_FILE_NAME [ipx::get_cores xilinx.com:user:pid_parameters:1.0]]]]
set hw_test_file ${ip_path}/example_designs/debug_hw_design/pid_parameters_v1_0_hw_test.tcl
...
for { set i 1 } { 1 } { incr i } {
	set design_name "pid_parameters_v1_0_hw_${i}"
